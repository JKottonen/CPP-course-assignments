...
int main()
{
    ...
    double pii = 3.1415;
    testaaTehtava1(ympyransade, pii);
    int x,y;
    x = 5.0;
    y = 5.0;
    y = testaaTehtava2(x,y); //Tässä on joitain vikaa, yritämme laskea kolmion korkeutta
    int a = 10;
    int b = 190;
    int c = 4;
    int tulos = (a + b) *c; //Tästä pitäisi saada tulos 800
    testaaTehtava3(tulos);
    float ika = 11.0; //Tässä on jotain vikaa, pitäisi luoda muuttuja jossa henkilön ikä
    cout << "T4. - OK" << endl;
    cout << "Anna lukuarvo: ";
